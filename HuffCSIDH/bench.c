...
void csidh_Huff_hy_bench()
{
    ...
    printf("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    printf("BENCHMARKING CSIDH HYBRID_HUFF  \n"); 
    printf("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    ...
    for(i=0; i<loop; i++)
    {
        ...
        cycles1 = cpucycles();
        csidh_Huff_Edwards(&pub_alice, &base_Huff, &priv_alice);
        csidh_Huff_Edwards(&pub_bob, &base_Huff, &priv_bob);
        csidh_Huff_Edwards(&shared_alice, &pub_bob, &priv_alice);
        csidh_Huff_Edwards(&shared_bob, &pub_alice, &priv_bob);
        cycles2 = cpucycles();
        alice_keygen = alice_keygen+((cycles2-cycles1)/4);
    }
...
void csidh_Huff_Edwards_sqrt_bench()
{
    ...
    printf("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    printf("BENCHMARKING CSIDH HUFF EDWARDS_SQRT \n"); 
    printf("\n--------------------------------------------------------------------------------------------------------\n\n"); 
    ...
    for(i=0; i<loop; i++)
    {
        ...
        cycles1 = cpucycles();
        csidh_Huff_sqrt_Edwards(&pub_alice, &base_Huff, &priv_alice);
        csidh_Huff_sqrt_Edwards(&pub_bob, &base_Huff, &priv_bob);
        csidh_Huff_sqrt_Edwards(&shared_alice, &pub_bob, &priv_alice);
        csidh_Huff_sqrt_Edwards(&shared_bob, &pub_alice, &priv_bob);
        cycles2 = cpucycles();
        alice_keygen = alice_keygen+((cycles2-cycles1)/4);
    }
